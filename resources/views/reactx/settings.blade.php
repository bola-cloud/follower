...
@section('content')
    <div class="max-w-4xl">
        ...
        @if (session('success'))
            <div
                class="mb-6 p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-xl text-green-800 dark:text-green-200">
                {{ session('success') }}
            </div>
        @endif
        ...
        @if ($errors->any())
            <div
                class="mb-6 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-xl text-red-800 dark:text-red-200">
        ...
        <!-- Settings Form -->
        <form action="{{ route('admin.front.settings.update') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea id="app_description" name="app_description" rows="4"
                    class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="Brief description of your app...">{{ old('app_description', $settings['app_description']) }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" id="seo_title" name="seo_title" value="{{ old('seo_title', $settings['seo_title']) }}"
                    required
                    class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500"
            ...
            <div>
                ...
                <textarea id="seo_description" name="seo_description" rows="3" required
                    class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="Meta description for search engines...">{{ old('seo_description', $settings['seo_description']) }}</textarea>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Supported formats: JPEG, PNG, GIF, WebP (Max
                        2MB)</p>
                </div>
            </div>
