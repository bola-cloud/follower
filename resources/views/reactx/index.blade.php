  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
      ...
      <form class="space-y-5" method="POST" action="{{ route('admin.apk.store') }}" enctype="multipart/form-data">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Option A: Upload APK File</label>
          <div class="relative">
          ...
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Max size: 150MB. PHP limits:
      ...
      try {
        const completeRes = await fetch("{{ route('admin.apk.upload.complete') }}", {
          ...
          body: JSON.stringify({
            ...
            apk_link: form.querySelector('input[name="apk_link"]').value,
        ...
        showMessage('APK uploaded successfully. Reloading...', 'success');
