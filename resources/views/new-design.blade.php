...
<body class="font-sans text-slate-800 antialiased bg-slate-50 overflow-x-hidden">
    ...
    <header class="fixed w-full top-0 z-50 transition-all duration-300" id="navbar">
        ...
        <div class="container mx-auto px-4 py-4 relative">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center gap-8">
                    ...
                    <a href="#how-it-works"
                        class="text-slate-600 hover:text-brand-purple transition-colors font-medium">How It Works</a>
                    <a href="#blog"
                        class="text-slate-600 hover:text-brand-purple transition-colors font-medium">Blog</a>
                    <a href="#safety"
                        class="text-slate-600 hover:text-brand-purple transition-colors font-medium">Safety</a>
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu"
            class="fixed inset-0 bg-white z-40 transform translate-x-full transition-transform duration-300 md:hidden pt-24 px-6">
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        <!-- Background Blobs -->
        <div class="hero-blob bg-brand-purple w-96 h-96 rounded-full top-0 left-0 -translate-x-1/2 -translate-y-1/4">
        </div>
        <div class="hero-blob bg-brand-pink w-96 h-96 rounded-full bottom-0 right-0 translate-x-1/3 translate-y-1/4">
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div class="lg:w-1/2 text-center lg:text-left z-10">
                    <div
                        class="inline-block px-4 py-1.5 rounded-full bg-brand-purple/10 text-brand-purple font-medium text-sm mb-6 border border-brand-purple/20">
                    ...
                    <p class="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                        Join thousands of creators growing their presence. Exchange likes, reacts, and followers in a
                        secure community environment. Real engagement from real users.
                    </p>
                    ...
                    <div
                        class="flex items-center justify-center lg:justify-start gap-4 text-xs text-slate-500 font-medium">
                ...
                <div class="lg:w-1/2 relative z-10 flex justify-center">
                    <div
                        class="relative w-72 h-[580px] bg-slate-900 rounded-[3rem] border-[8px] border-slate-900 shadow-2xl overflow-hidden">
                        <!-- Notch -->
                        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-slate-900 rounded-b-xl z-20">
                        </div>
                        ...
                        <div class="w-full h-full bg-slate-50 relative overflow-hidden">
                            ...
                            <!-- Stats Card -->
                            <div
                                class="mx-4 -mt-6 bg-white rounded-xl shadow-lg p-4 flex justify-between text-center z-10 relative">
                                <div>
                            ...
                            <div class="p-4 space-y-4 mt-2">
                                <div
                                    class="bg-white p-3 rounded-xl shadow-sm border border-slate-100 flex items-center gap-3">
                                ...
                                <div
                                    class="bg-white p-3 rounded-xl shadow-sm border border-slate-100 flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-pink-400 to-pink-600">
                                    </div>
                                    <div class="flex-1">
                                ...
                                <div
                                    class="bg-white p-3 rounded-xl shadow-sm border border-slate-100 flex items-center gap-3 opacity-60">
                                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-purple-400 to-purple-600">
                                    </div>
                                    <div class="flex-1">
                                        <div class="h-2 w-24 bg-slate-200 rounded mb-1.5"></div>
                                        <div class="h-2 w-16 bg-slate-100 rounded"></div>
                            ...
                            <div class="absolute bottom-6 left-0 right-0 px-6">
                                <div
                                    class="w-full bg-slate-900 text-white py-3 rounded-xl text-center text-sm font-bold">
                                    Start Boosting
                                </div>
                            </div>
                        </div>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <!-- Feature 1 -->
                <div
                    class="bg-slate-50 p-8 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100">
                    ...
                    <p class="text-slate-600 leading-relaxed">Connect with genuine active users. No bots or fake
                        accounts in our ecosystem.</p>
                </div>
                ...
                <div
                    class="bg-slate-50 p-8 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100">
                    <div
                        class="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center text-brand-purple mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-7 h-7">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <p class="text-slate-600 leading-relaxed">See results immediately after requesting. Our system
                        processes exchanges in real-time.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Choose exactly which posts get attention and what kind of
                        reactions you want.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed">Your account safety is our priority. We use advanced
                        encryption and never ask for passwords.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    {{-- <section id="pricing" class="py-20 bg-slate-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-center">
                <!-- Starter Package -->
                <div
                    class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 hover:shadow-xl transition-all duration-300">
                    <div class="text-slate-500 font-medium mb-4">Starter Pack</div>
                    <div class="text-4xl font-bold text-slate-900 mb-2">500 <span
                            class="text-lg font-normal text-slate-500">Coins</span></div>
                    ...
                    <button
                        class="w-full py-3 rounded-xl border-2 border-slate-200 font-bold text-slate-700 hover:border-brand-purple hover:text-brand-purple transition-colors">Buy
                        Now</button>
                </div>

                <!-- Pro Package (Popular) -->
                <div
                    class="bg-white p-8 rounded-3xl shadow-xl border-2 border-brand-purple relative transform md:-translate-y-4">
                    <div
                        class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-brand-purple to-brand-pink text-white px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wide">
                        Most Popular</div>

                    <div class="text-brand-purple font-bold mb-4">Pro Pack</div>
                    <div class="text-4xl font-bold text-slate-900 mb-2">2500 <span
                            class="text-lg font-normal text-slate-500">Coins</span></div>
                    ...
                    <ul class="space-y-4 mb-8 text-slate-600 font-medium">
                        <li class="flex items-center gap-3">
                            <div
                                class="w-5 h-5 rounded-full bg-brand-purple/10 flex items-center justify-center text-brand-purple text-xs">
                                ✓</div>
                    ...
                    <button
                        class="w-full py-4 rounded-xl bg-gradient-to-r from-brand-purple to-brand-pink text-white font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all">Buy
                        Now</button>
                </div>
                ...
                <div
                    ...
                    <div class="text-4xl font-bold text-slate-900 mb-2">10000 <span
                            class="text-lg font-normal text-slate-500">Coins</span></div>
                    ...
                    <button
                        class="w-full py-3 rounded-xl border-2 border-slate-200 font-bold text-slate-700 hover:border-brand-blue hover:text-brand-blue transition-colors">Buy
                        Now</button>
                </div>
            </div>
        </div>
    ...
    <section id="how-it-works" class="py-20 bg-slate-50 relative overflow-hidden">
        <div
            class="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%238b5cf6\' fill-opacity=\'0.05\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50">
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start gap-8 max-w-5xl mx-auto">
                ...
                <div class="flex-1 text-center relative group">
                    <div
                        class="w-20 h-20 bg-white rounded-2xl shadow-md flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-brand-purple border border-slate-100 relative z-10">
                        1
                    </div>
                    <!-- Line Connector -->
                    ...
                    <p class="text-slate-600 text-sm px-4">Get the app and simply enter your username. No password
                        needed to start.</p>
                </div>
                ...
                <div class="flex-1 text-center relative group">
                    <div
                        class="w-20 h-20 bg-white rounded-2xl shadow-md flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-brand-pink border border-slate-100 relative z-10">
                        2
                    </div>
                    <!-- Line Connector -->
                    <div class="hidden md:block absolute top-10 left-1/2 w-full h-0.5 bg-slate-200 -z-0"></div>
                    ...
                    <p class="text-slate-600 text-sm px-4">Select whether you want more followers, likes, or custom
                        reactions.</p>
                </div>
                ...
                <div class="flex-1 text-center relative group">
                    <div
                        class="w-20 h-20 bg-white rounded-2xl shadow-md flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-brand-blue border border-slate-100 relative z-10">
                        3
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Watch It Grow</h3>
                    <p class="text-slate-600 text-sm px-4">Sit back and watch your engagement numbers climb instantly.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="blog" class="py-20 bg-slate-50">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-end mb-12 max-w-6xl mx-auto">
                ...
                <a href="#"
                    class="hidden md:flex items-center gap-2 text-brand-purple font-medium hover:gap-3 transition-all">
                    View all articles
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            <div
                                class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 shrink-0 mt-1">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm">We only need your public username to deliver
                                    engagement.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            <div
                                class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-brand-blue shrink-0 mt-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="w-5 h-5">
                                    <path fill-rule="evenodd"
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-sm">All engagement comes from our network of real mobile
                                    users.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            <div
                                class="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-brand-purple shrink-0 mt-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                    class="w-5 h-5">
                                    <path fill-rule="evenodd"
                                        d="M2 10c0-3.967 3.69-7 8-7 4.31 0 8 3.033 8 7s-3.69 7-8 7a6.99 6.99 0 01-2.913-.64l-4.272 1.265a.75.75 0 01-.945-.944l1.265-4.272A6.985 6.985 0 012 10zm8 1a1 1 0 100-2 1 1 0 000 2z"
                                        clip-rule="evenodd" />
                                </svg>
                            </div>
                            <div>
                                <h4 class="text-lg font-bold text-slate-900">24/7 Support</h4>
                                <p class="text-slate-600 text-sm">Our team is always ready to help with any questions or
                                    issues.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="mt-10 inline-flex items-center gap-3 px-5 py-2 bg-slate-50 rounded-full border border-slate-200 text-sm font-medium text-slate-600">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            class="w-12 h-12 rounded-full bg-gradient-to-tr from-yellow-400 to-orange-500 flex items-center justify-center text-white font-bold text-lg">
                            S</div>
                        <div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            class="w-12 h-12 rounded-full bg-gradient-to-tr from-blue-400 to-cyan-500 flex items-center justify-center text-white font-bold text-lg">
                            M</div>
                        <div>
                    ...
                    <p class="text-slate-600 italic">"Super easy to use and the results are instant. Love that I don't
                        have to give my password. 10/10 recommended."</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            class="w-12 h-12 rounded-full bg-gradient-to-tr from-purple-400 to-pink-500 flex items-center justify-center text-white font-bold text-lg">
                            A</div>
                        <div>
                    ...
                    <p class="text-slate-600 italic">"Best app for growing new accounts. The community aspect is great
                        and the exchange system is very fair."</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 max-w-3xl">
            ...
            <div class="space-y-4">
                ...
                <div class="border border-slate-200 rounded-2xl overflow-hidden">
                    <button
                        class="faq-btn w-full px-6 py-4 text-left bg-white hover:bg-slate-50 flex justify-between items-center transition-colors">
                        <span class="font-bold text-slate-900">Is this safe for my Instagram account?</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor" class="w-5 h-5 transform transition-transform duration-300 faq-icon">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                    </button>
                    <div class="faq-content hidden bg-slate-50 px-6 py-4 text-slate-600 border-t border-slate-100">
                        Yes, absolutely. We operate within Instagram's community guidelines. Since we use real users and
                        don't require your password, your account remains completely secure.
                    </div>
                </div>
                ...
                <div class="border border-slate-200 rounded-2xl overflow-hidden">
                    ...
                    <div class="faq-content hidden bg-slate-50 px-6 py-4 text-slate-600 border-t border-slate-100">
                        No! We will never ask for your Instagram password. We only need your username to know where to
                        send the followers and reacts.
                    </div>
                </div>
    ...
    <section class="py-20 bg-slate-900 relative overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-brand-purple to-brand-pink opacity-10">
        </div>

        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Get Free Coins & Updates</h2>
                <p class="text-slate-300 mb-8 text-lg">Subscribe to our newsletter and get a promo code for 100 free
                    coins delivered to your inbox.</p>

                <form class="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto" onsubmit="event.preventDefault();">
                    <input type="email" placeholder="Enter your email address"
                        class="flex-1 px-6 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-purple backdrop-blur-sm">
                    <button type="submit"
                        class="bg-white text-brand-purple px-8 py-4 rounded-xl font-bold hover:bg-slate-100 transition-colors shadow-lg">
                        Subscribe
                    </button>
                </form>
    ...
    <section id="download" class="py-20 px-4">
        <div class="container mx-auto max-w-5xl">
            <div
                class="bg-gradient-to-r from-brand-purple to-brand-pink rounded-3xl p-8 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
                <!-- Decorative circles -->
                <div
                    class="absolute top-0 left-0 w-64 h-64 bg-white opacity-10 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl">
                </div>
                <div
                    class="absolute bottom-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl">
                </div>

                <h2 class="text-3xl md:text-5xl font-bold mb-6 relative z-10">Ready to Boost Your Instagram?</h2>
                <p class="text-lg md:text-xl mb-10 opacity-90 max-w-2xl mx-auto relative z-10">Download the app now and
                    see the difference in minutes. Join the fastest growing community today.</p>
