          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('admin.dashboard') }}">
                ...
                <h3 class="brand-text mb-0 d-flex align-items-center">
                    <i class="fab fa-instagram me-2 ms-2"></i><span>EG Followers</span>
                </h3>
            </a>
  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-envelope"></i><span class="menu-title" data-i18n="nav.dash.main"> ادارة الطلبات </a>
                <ul class="menu-content">
